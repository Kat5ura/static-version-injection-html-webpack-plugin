...
function StaticVersionInjectionWebpackPlugin(options) {
    ...
    // when you want to modify a template file directly, set this option to true
    this.sameOrigin = options.sameOrigin || false;

    // when sameOrigin option is true, you can set a hold option to decide which assets will be hold in the clean processing
